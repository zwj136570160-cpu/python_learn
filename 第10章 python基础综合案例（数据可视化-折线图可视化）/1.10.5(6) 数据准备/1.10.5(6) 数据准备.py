...
#   印度的数据处理
util.dp(
    fp=r"E:\python练习\python学习\第10章 python基础综合案例（数据可视化-折线图可视化）\1.10.5(6) 数据准备\折线图数据\印度.txt",
...
#   日本的数据处理
util.dp(
    fp=r"E:\python练习\python学习\第10章 python基础综合案例（数据可视化-折线图可视化）\1.10.5(6) 数据准备\折线图数据\日本.txt",
